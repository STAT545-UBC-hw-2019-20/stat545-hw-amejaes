...
What information is present in the dataset? 
Below are Gapminder's column headings:
```{r, echo=FALSE}
...
datatable(as_tibble(min_pop_recent))
```
...
## Learn more
To learn more, you can explore the dataset yourself here:
```{r, echo=FALSE}
